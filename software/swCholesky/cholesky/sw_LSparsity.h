...
#ifndef SW_LSPARSITY_H
#define SW_LSPARSITY_H
...
/*    RETURN_IF_NULL_COMMON (NULL) ;
 ...
 std::cout << "analyze_p2, get inputs" << std::endl;
 n = A->nrow ;
 ncol = A->ncol ;
 ...
 std::cout << "analyze_p2, set default strategy" << std::endl;
...
/*    default_strategy = (nmethods == 0) ;
 ...
 std::cout << "analyze_p2, allocate workspace" << std::endl;
...
//        ERROR (CHOLMOD_TOO_LARGE, "problem too large") ;
 ...
 std::cout << "analyze_p2, allocate more space" << std::endl;
...
#else
 assert(0 && "ERROR in analyze_p2, NO GIVEN\n");
#endif
 ...
 orderingTime = elapsed_seconds;
//printf("ddddd %f ddd \n",orderingTime);
#ifdef VERIFY
 bool *checkOrder = new bool[ncol]();
...
/*    Common->fl  = Common->method [Common->selected].fl  ;
 ...
 if(supernodal)
 {
  ...
  gettimeofday(&end, 0L);
  elapsed_seconds = TIME(start, end);
  double duration1 = elapsed_seconds;
