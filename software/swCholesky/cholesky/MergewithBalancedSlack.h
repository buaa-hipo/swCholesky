...
int mergingWithBalancedSlack(int n, int *eTree, int *nodeCost, int *parCost, int *Node2Par, int *nChild,
 ...
 int *slackNumber = new int[n]();
 std::vector<int> criticalLeaves;
 int *nChildArtTree = new int[partitionNo]();
 int *partitionMaxLevels = new int[partitionNo]();
 int *partitionMinLevels = new int[partitionNo]();
 int *initLevelPtr = new int[n+1]();
 int *initLevelSet = new int[n]();
 int *levelPtr = new int[n+1]();
 int *levelSet = new int[n]();
 int *node2Level = new int[n]();
 int *childPtrSubtree=new int[n+1](),
 ...
 int *levelCost = new int[levelNo]();
 int *curLevelCost = new int[levelNo]();
 int *levelParCost = new int[levelNo]();
 for (int i = 0; i < n; ++i) {
