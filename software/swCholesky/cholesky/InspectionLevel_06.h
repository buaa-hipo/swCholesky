...
/* for (int i = 0; i < partitionNo; ++i) {
 ...
 double *levelCost = new double[levelNo]();
 double *curLevelCost = new double[levelNo]();
 double *levelParCost = new double[levelNo]();
 for (int i = 0; i < n; ++i) {
